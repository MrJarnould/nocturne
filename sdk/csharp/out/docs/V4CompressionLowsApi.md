# NightscoutFoundation.Nocturne.Api.V4CompressionLowsApi
...
namespace Example
{
    public class CompressionLowAcceptSuggestionExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new V4CompressionLowsApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowAcceptSuggestion: " + e.Message);
...
{
    Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowAcceptSuggestionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CompressionLowDeleteSuggestionExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowDeleteSuggestion: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowDeleteSuggestionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CompressionLowDismissSuggestionExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowDismissSuggestion: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowDismissSuggestionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CompressionLowGetSuggestionExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowGetSuggestion: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowGetSuggestionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CompressionLowGetSuggestionsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowGetSuggestions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowGetSuggestionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CompressionLowTriggerDetectionExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowTriggerDetection: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4CompressionLowsApi.CompressionLowTriggerDetectionWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
