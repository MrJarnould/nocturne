# NightscoutFoundation.Nocturne.Api.V4ClockFacesApi
...
namespace Example
{
    public class ClockFacesCreateExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new V4ClockFacesApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesCreate: " + e.Message);
...
{
    Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesCreateWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ClockFacesDeleteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesDelete: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesDeleteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ClockFacesGetByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesGetById: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesGetByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ClockFacesListExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesList: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesListWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ClockFacesUpdateExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesUpdate: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4ClockFacesApi.ClockFacesUpdateWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
