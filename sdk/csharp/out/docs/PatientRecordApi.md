# NightscoutFoundation.Nocturne.Api.PatientRecordApi
...
namespace Example
{
    public class PatientRecordCreateDeviceExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PatientRecordApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordCreateDevice: " + e.Message);
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordCreateDeviceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordCreateInsulinExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordCreateInsulin: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordCreateInsulinWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordDeleteDeviceExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordDeleteDevice: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordDeleteDeviceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordDeleteInsulinExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordDeleteInsulin: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordDeleteInsulinWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordGetDevicesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordGetDevices: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordGetDevicesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordGetInsulinsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordGetInsulins: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordGetInsulinsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordGetPatientRecordExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordGetPatientRecord: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordGetPatientRecordWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordUpdateDeviceExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordUpdateDevice: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordUpdateDeviceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordUpdateInsulinExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordUpdateInsulin: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordUpdateInsulinWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PatientRecordUpdatePatientRecordExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PatientRecordApi.PatientRecordUpdatePatientRecord: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PatientRecordApi.PatientRecordUpdatePatientRecordWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
