# NightscoutFoundation.Nocturne.Api.AlertInvitesApi
...
namespace Example
{
    public class AlertInvitesCreateInviteExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AlertInvitesApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesCreateInvite: " + e.Message);
...
{
    Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesCreateInviteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertInvitesRedeemInviteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesRedeemInvite: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesRedeemInviteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertInvitesRevokeInviteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesRevokeInvite: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesRevokeInviteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertInvitesValidateInviteExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesValidateInvite: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertInvitesApi.AlertInvitesValidateInviteWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
