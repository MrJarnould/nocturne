# NightscoutFoundation.Nocturne.Api.RoleApi
...
namespace Example
{
    public class RoleCreateRoleExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new RoleApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling RoleApi.RoleCreateRole: " + e.Message);
...
{
    Debug.Print("Exception when calling RoleApi.RoleCreateRoleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class RoleDeleteRoleExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling RoleApi.RoleDeleteRole: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling RoleApi.RoleDeleteRoleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class RoleGetRolesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling RoleApi.RoleGetRoles: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling RoleApi.RoleGetRolesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class RoleUpdateRoleExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling RoleApi.RoleUpdateRole: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling RoleApi.RoleUpdateRoleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
