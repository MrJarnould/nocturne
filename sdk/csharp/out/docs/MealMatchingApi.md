# NightscoutFoundation.Nocturne.Api.MealMatchingApi
...
namespace Example
{
    public class MealMatchingAcceptMatchExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new MealMatchingApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling MealMatchingApi.MealMatchingAcceptMatch: " + e.Message);
...
{
    Debug.Print("Exception when calling MealMatchingApi.MealMatchingAcceptMatchWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MealMatchingDismissMatchExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MealMatchingApi.MealMatchingDismissMatch: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MealMatchingApi.MealMatchingDismissMatchWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MealMatchingGetFoodEntryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MealMatchingApi.MealMatchingGetFoodEntry: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MealMatchingApi.MealMatchingGetFoodEntryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MealMatchingGetSuggestionsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MealMatchingApi.MealMatchingGetSuggestions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MealMatchingApi.MealMatchingGetSuggestionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
