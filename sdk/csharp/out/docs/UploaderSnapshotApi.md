# NightscoutFoundation.Nocturne.Api.UploaderSnapshotApi
...
namespace Example
{
    public class UploaderSnapshotGetAllExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new UploaderSnapshotApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling UploaderSnapshotApi.UploaderSnapshotGetAll: " + e.Message);
...
{
    Debug.Print("Exception when calling UploaderSnapshotApi.UploaderSnapshotGetAllWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class UploaderSnapshotGetByIdExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UploaderSnapshotApi.UploaderSnapshotGetById: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling UploaderSnapshotApi.UploaderSnapshotGetByIdWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
