# NightscoutFoundation.Nocturne.Api.AlertCustomSoundsApi
...
namespace Example
{
    public class AlertCustomSoundsDeleteSoundExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AlertCustomSoundsApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsDeleteSound: " + e.Message);
...
{
    Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsDeleteSoundWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertCustomSoundsGetSoundsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsGetSounds: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsGetSoundsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertCustomSoundsStreamSoundExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsStreamSound: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsStreamSoundWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertCustomSoundsUploadSoundExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsUploadSound: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertCustomSoundsApi.AlertCustomSoundsUploadSoundWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
