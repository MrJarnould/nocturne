# NightscoutFoundation.Nocturne.Api.DebugApi
...
namespace Example
{
    public class DebugEchoQueryExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DebugApi.DebugEchoQuery: " + e.Message);
...
{
    Debug.Print("Exception when calling DebugApi.DebugEchoQueryWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class DebugEchoQueryWithModelExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DebugApi.DebugEchoQueryWithModel: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling DebugApi.DebugEchoQueryWithModelWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class DebugEchoQueryWithModelAndSpecExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DebugApi.DebugEchoQueryWithModelAndSpec: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling DebugApi.DebugEchoQueryWithModelAndSpecWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class DebugPreviewEntriesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling DebugApi.DebugPreviewEntries: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling DebugApi.DebugPreviewEntriesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
