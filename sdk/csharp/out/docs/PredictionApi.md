# NightscoutFoundation.Nocturne.Api.PredictionApi
...
namespace Example
{
    public class PredictionGetPredictionsExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new PredictionApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling PredictionApi.PredictionGetPredictions: " + e.Message);
...
{
    Debug.Print("Exception when calling PredictionApi.PredictionGetPredictionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class PredictionGetStatusExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling PredictionApi.PredictionGetStatus: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling PredictionApi.PredictionGetStatusWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
