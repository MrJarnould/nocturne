# NightscoutFoundation.Nocturne.Api.AlertRulesApi
...
namespace Example
{
    public class AlertRulesCreateRuleExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AlertRulesApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling AlertRulesApi.AlertRulesCreateRule: " + e.Message);
...
{
    Debug.Print("Exception when calling AlertRulesApi.AlertRulesCreateRuleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertRulesDeleteRuleExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertRulesApi.AlertRulesDeleteRule: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertRulesApi.AlertRulesDeleteRuleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertRulesGetRuleExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertRulesApi.AlertRulesGetRule: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertRulesApi.AlertRulesGetRuleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertRulesGetRulesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertRulesApi.AlertRulesGetRules: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertRulesApi.AlertRulesGetRulesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertRulesToggleRuleExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertRulesApi.AlertRulesToggleRule: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertRulesApi.AlertRulesToggleRuleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class AlertRulesUpdateRuleExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling AlertRulesApi.AlertRulesUpdateRule: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling AlertRulesApi.AlertRulesUpdateRuleWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
