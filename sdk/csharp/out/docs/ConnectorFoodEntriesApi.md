# NightscoutFoundation.Nocturne.Api.ConnectorFoodEntriesApi
...
namespace Example
{
    public class ConnectorFoodEntriesImportEntriesExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ConnectorFoodEntriesApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling ConnectorFoodEntriesApi.ConnectorFoodEntriesImportEntries: " + e.Message);
...
{
    Debug.Print("Exception when calling ConnectorFoodEntriesApi.ConnectorFoodEntriesImportEntriesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
