# NightscoutFoundation.Nocturne.Api.V4RetrospectiveApi
...
namespace Example
{
    public class RetrospectiveGetBasalTimelineExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new V4RetrospectiveApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling V4RetrospectiveApi.RetrospectiveGetBasalTimeline: " + e.Message);
...
{
    Debug.Print("Exception when calling V4RetrospectiveApi.RetrospectiveGetBasalTimelineWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class RetrospectiveGetRetrospectiveDataExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4RetrospectiveApi.RetrospectiveGetRetrospectiveData: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4RetrospectiveApi.RetrospectiveGetRetrospectiveDataWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class RetrospectiveGetRetrospectiveTimelineExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4RetrospectiveApi.RetrospectiveGetRetrospectiveTimeline: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4RetrospectiveApi.RetrospectiveGetRetrospectiveTimelineWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
