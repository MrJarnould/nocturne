# NightscoutFoundation.Nocturne.Api.MyFitnessPalSettingsApi
...
namespace Example
{
    public class MyFitnessPalSettingsGetSettingsExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new MyFitnessPalSettingsApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling MyFitnessPalSettingsApi.MyFitnessPalSettingsGetSettings: " + e.Message);
...
{
    Debug.Print("Exception when calling MyFitnessPalSettingsApi.MyFitnessPalSettingsGetSettingsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class MyFitnessPalSettingsSaveSettingsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MyFitnessPalSettingsApi.MyFitnessPalSettingsSaveSettings: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MyFitnessPalSettingsApi.MyFitnessPalSettingsSaveSettingsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
