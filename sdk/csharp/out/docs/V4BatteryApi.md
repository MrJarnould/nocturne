# NightscoutFoundation.Nocturne.Api.V4BatteryApi
...
namespace Example
{
    public class BatteryGetBatteryReadingsExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new V4BatteryApi(httpClient, config, httpClientHandler);
            ...
            {
                Debug.Print("Exception when calling V4BatteryApi.BatteryGetBatteryReadings: " + e.Message);
...
{
    Debug.Print("Exception when calling V4BatteryApi.BatteryGetBatteryReadingsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class BatteryGetBatteryStatisticsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4BatteryApi.BatteryGetBatteryStatistics: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4BatteryApi.BatteryGetBatteryStatisticsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class BatteryGetChargeCyclesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4BatteryApi.BatteryGetChargeCycles: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4BatteryApi.BatteryGetChargeCyclesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class BatteryGetCurrentBatteryStatusExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4BatteryApi.BatteryGetCurrentBatteryStatus: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4BatteryApi.BatteryGetCurrentBatteryStatusWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class BatteryGetKnownDevicesExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling V4BatteryApi.BatteryGetKnownDevices: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling V4BatteryApi.BatteryGetKnownDevicesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
