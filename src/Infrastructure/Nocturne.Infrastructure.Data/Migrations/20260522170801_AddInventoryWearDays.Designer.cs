...
namespace Nocturne.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260522170801_AddInventoryWearDays")]
    partial class AddInventoryWearDays
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InventoryBatchEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("InventoryItemId", "ExpiresAt", "ReceivedAt")
                        .HasDatabaseName("ix_inventory_batches_item_expiry_received");

                    b.ToTable("inventory_batches");
                });

            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InventoryItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AutoConsumeEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_consume_enabled");

                    b.Property<string>("AutoConsumeSource")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("auto_consume_source");
                    ...
                    b.Property<string>("DeviceEventTypesJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("device_event_types_json");
                    ...
                    b.Property<Guid?>("LinkedInsulinItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("linked_insulin_item_id");

                    b.Property<decimal?>("LinkedInsulinUnitsPerUse")
                        .HasColumnType("numeric")
                        .HasColumnName("linked_insulin_units_per_use");
                    ...
                    b.Property<Guid?>("PatientInsulinId")
                        .HasColumnType("uuid")
                        .HasColumnName("patient_insulin_id");
                    ...
                    b.Property<int?>("WearDays")
                        .HasColumnType("integer")
                        .HasColumnName("wear_days");

                    b.HasKey("Id");

                    b.HasIndex("LinkedInsulinItemId")
                        .HasDatabaseName("ix_inventory_items_linked_insulin_id")
                        .HasFilter("linked_insulin_item_id IS NOT NULL");

                    b.HasIndex("PatientInsulinId")
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InventoryTransactionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "InventoryItemId", "SourceType", "SourceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InventoryBatchEntity", b =>
                {
                    b.HasOne("Nocturne.Infrastructure.Data.Entities.InventoryItemEntity", "Item")
                        .WithMany("Batches")
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InventoryItemEntity", b =>
                {
                    b.HasOne("Nocturne.Infrastructure.Data.Entities.InventoryItemEntity", null)
                        .WithMany()
                        .HasForeignKey("LinkedInsulinItemId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Nocturne.Infrastructure.Data.Entities.InventoryTransactionEntity", b =>
                {
                    b.HasOne("Nocturne.Infrastructure.Data.Entities.InventoryBatchEntity", "Batch")
                        .WithMany()
